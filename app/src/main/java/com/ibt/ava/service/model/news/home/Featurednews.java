...
public class Featurednews {
    ...
    public boolean isSpecialFeatured() {
        return isSpecialFeatured;
    }

    public void setSpecialFeatured(boolean specialFeatured) {
        isSpecialFeatured = specialFeatured;
    }
    ...
    public boolean isBreakingNewsSlider() {
        return isBreakingNewsSlider;
    }

    public void setBreakingNewsSlider(boolean breakingNewsSlider) {
        isBreakingNewsSlider = breakingNewsSlider;
    }

    public boolean isChoicesForYou() {
        return isChoicesForYou;
    }

    public void setChoicesForYou(boolean choicesForYou) {
        isChoicesForYou = choicesForYou;
    }
    ...
    public boolean isHighlightedBreakingNews() {
        return isHighlightedBreakingNews;
    }

    public void setHighlightedBreakingNews(boolean highlightedBreakingNews) {
        isHighlightedBreakingNews = highlightedBreakingNews;
    }

    public boolean isHighlightedOpinion() {
        return isHighlightedOpinion;
    }

    public void setHighlightedOpinion(boolean highlightedOpinion) {
        isHighlightedOpinion = highlightedOpinion;
    }

    public boolean isSpecialToAva() {
        return isSpecialToAva;
    }

    public void setSpecialToAva(boolean specialToAva) {
        isSpecialToAva = specialToAva;
    }

    public boolean isFastNews() {
        return isFastNews;
    }

    public void setFastNews(boolean fastNews) {
        isFastNews = fastNews;
    }
