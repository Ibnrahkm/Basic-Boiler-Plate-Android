...
import com.ibt.ava.databinding.LayoutMultimediaScreenImagesRowBinding
...
* */
class MultimediaImagesDataAdapter constructor(val context: Activity) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return if (viewType == TYPE_FOOTER) {
            ...
            TransactionViewHolder(
                DataBindingUtil.inflate<LayoutMultimediaScreenImagesRowBinding>(
                    LayoutInflater.from(context),
                    R.layout.layout_multimedia_screen_images_row, parent, false
                )
            )
        }
    }
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (holder is FooterViewHolder) {
          ...
          /*  if (position % 2 == 0) {
            ...
            holder.binding.tvImagesCount.setText(dataList[position].mediaGallery.size.toString()+"وێنە ")
     ...
     */
    fun provideData(dataList: ArrayList<Data>) {
    ...
    inner class TransactionViewHolder constructor(internal var binding: LayoutMultimediaScreenImagesRowBinding) :
