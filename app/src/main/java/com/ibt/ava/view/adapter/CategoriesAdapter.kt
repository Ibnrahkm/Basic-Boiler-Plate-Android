...
import com.ibt.ava.databinding.LayoutCatRowBinding
...
import com.ibt.ava.service.model.news.categories.Datum
...
* */
class CategoriesAdapter constructor(val context: Activity) :
    RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    /**
     * global variables
     */
    var dataList: List<StaticCategory> = ArrayList<StaticCategory>()
    var clickedData: MutableLiveData<StaticCategory> = MutableLiveData<StaticCategory>()
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return if (viewType == TYPE_FOOTER) {
            ...
            TransactionViewHolder(
                DataBindingUtil.inflate<LayoutCatRowBinding>(
                    LayoutInflater.from(context),
                    R.layout.layout_cat_row, parent, false
                )
            )
        }
    }
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (holder is FooterViewHolder) {
            ...
            holder.binding.root.setOnClickListener {
                ...
                var bun = Bundle()
                bun.putString("id", dataList[position].id)
                bun.putString("name", dataList[position].name)
                f.arguments = bun
     ...
     */
    fun provideData(dataList: List<StaticCategory>) {
    ...
    inner class TransactionViewHolder constructor(internal var binding: LayoutCatRowBinding) :
