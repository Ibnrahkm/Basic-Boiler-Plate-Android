...
import com.ibt.ava.databinding.LayoutHomeScreenVideoRowBinding
...
* */
class HomeScreenVideoAdapter constructor(val context: Activity) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return if (viewType == TYPE_FOOTER) {
            ...
            TransactionViewHolder(
                DataBindingUtil.inflate<LayoutHomeScreenVideoRowBinding>(
                    LayoutInflater.from(context),
                    R.layout.layout_home_screen_video_row, parent, false
                )
            )
        }
    }
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (holder is FooterViewHolder) {
            ...
            /* holder.binding.btnPlay.setOnClickListener {
                 Helper.openYoutube(dataList[position].youtubeKey, context)
             }*/
        }
    }
    ...
    inner class TransactionViewHolder constructor(internal var binding: LayoutHomeScreenVideoRowBinding) :
