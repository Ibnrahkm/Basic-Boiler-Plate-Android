...
import com.ibt.ava.databinding.LayoutScoopRowBinding
...
* */
class HomeForthSectionScoopDataAdapter constructor(val context: Activity) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return if (viewType == TYPE_FOOTER) {
            ...
            TransactionViewHolder(
                DataBindingUtil.inflate<LayoutScoopRowBinding>(
                    LayoutInflater.from(context),
                    R.layout.layout_scoop_row, parent, false
                )
            )
        }
    }
    ...
    inner class TransactionViewHolder constructor(internal var binding: LayoutScoopRowBinding) :
